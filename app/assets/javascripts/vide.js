;(function ($, window, document, navigator) {
     ...
     * Is iOs or Android?
     */
    let iOS = /iPad|iPhone|iPod/i.test(navigator.userAgent),
     ...
     * @returns {Object}
     */
    let parseOptions = function (str) {
        let obj = {}, clearedStr, arr;
     ...
     * @returns {{x: *, y: *}}
     */
    let parsePosition = function (str) {
     ...
     * @param callback
     */
    let findPoster = function (path, callback) {
        let onLoad = function () {
            callback(this.src);
        };
        $("<img src='" + path + ".jpg'>").load($("#vider-element").data("vide-bg"),onLoad);
        $("<img src='" + path + ".gif'>").load($("#vider-element").data("vide-bg"),onLoad);
        $("<img src='" + path + ".jpeg'>").load($("#vider-element").data("vide-bg"),onLoad);
        $("<img src='" + path + ".png'>").load($("#vider-element").data("vide-bg"),onLoad);
    };
    ...
    Vide.prototype.resize = function () {
        ...
        let videoHeight = this.video[0].videoHeight,
    ...
    $(document).ready(function () {
        ...
        $(window).bind("resize." + pluginName, function () {
            for (let len = $[pluginName].lookup.length, instance, i = 0; i < len; i++) {
